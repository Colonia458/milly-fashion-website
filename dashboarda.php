...
<body>
    ...
    <div class="main-content">
        <div class="header-wrapper">
            ...
            <div id="section1">
                <h2 class="stamp">MANAGE ACCESSORIES PRODUCTS</h2>

                <div class="container">
                    <div class="form-section">
                        <form id="addaccessform" action="addaccess.php" method="post" enctype="multipart/form-data">
            
                            <h3>Add New Accessory Product</h3>
                        ...
                        <table>
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td><img src='Pictures/Accessories/WhatsAppImage2024-02-05at4.18.14PM_1.webp' ".$row["image"]."' height='100'></td>";
                                    echo "</tr>";
                                }
                            } else {

...
<body>
    ...
    <div class="main-content">
        <div class="header-wrapper">
            ...
            <div id="section1">
                <h2 class="stamp">MANAGE SHOE PRODUCTS</h2>

                <div class="container">
                    <div class="form-section">
                        <form id="addshoeform" action="addshoe.php" method="post" enctype="multipart/form-data">
            
                            <h3>Add New Shoe Product</h3>
                        ...
                        <table>
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td><img src='Pictures/Shoes/ezgif-5-caeb20d1ff.jpg' ".$row["image"]."' height='100'></td>";
                                    echo "</tr>";
                                }
                            } else {
